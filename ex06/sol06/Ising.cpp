...
template<unsigned ISING_DIM>
template<typename T>
void Ising<ISING_DIM>::step_N(unsigned num){
...
template<unsigned ISING_DIM>
const std::vector<short int>& Ising<ISING_DIM>::get_configuration() const{
  return spins_;
}
...
template void Ising<2u>::step_N<MRT_type>(unsigned);
