...
Metropolis::Metropolis(int L, int dimension) : IsingLattice(L, dimension) {}

void Metropolis::doSweep(const int sweep_size)
{
...
void Metropolis::increaseEnergy()
{
...
void Metropolis::energize(int energy)
{
  for (int i = 0; i < n_; ++i)
  {
